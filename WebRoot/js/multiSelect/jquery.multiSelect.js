...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			if( o.selectAllText == undefined ) o.selectAllText = "全选/取消";
			if( o.noneSelected == undefined ) o.noneSelected = '';
			if( o.oneOrMoreSelected == undefined ) o.oneOrMoreSelected = '% 被选中';
			...
			$(this).each( function() {
                ...
                multiSelect.find("span").css("width", '120px');
                multiSelect.find("span").css("height", '21px');
