         	...
         	'-',
       		{
                ...
                handler:function(){
                 	var deleteConfig = {
                 		url:'orderSaleMgr!deleteOrdersProducts.action',
...
function saverow(target){
     var config = {
		  msg:'确定修改吗？',
		  url:'orderSaleMgr!updateOrdersProduct.action',
		  serviceKey:'updated',
		  rs:'修改',
		  data:titleJsonProp()
       	};  
...
function deleterow(target){
    ...
    var config = {
		  url:'orderSaleMgr!deleteOrderProducts.action',
		  data:row
       	};  
