  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="${pageContext.request.contextPath}/suppliers/suppliersMgr!list.action" target="main">供应商管理</a></li>
          <li><a href="${pageContext.request.contextPath}/shipments/shipmentsMgr!list.action" target="main">查看进货单</a></li>
          <li><a href="${pageContext.request.contextPath}/suppliers/addGoods.jsp" target="main">进货</a></li>
        </ul>
      </div>
      <h1 class="type"><a href="javascript:void(0)">出货管理</a></h1>
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="images/menu_topline.gif" width="182" height="5" /></td>
      ...
      <div class="content">
        ...
        <h1 class="type"><a href="javascript:void(0)">其它参数</a></h1>
      <div class="content">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><img src="images/menu_topline.gif" width="182" height="5" /></td>
